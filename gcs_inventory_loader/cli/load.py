...
# from gcs_inventory_loader.cli.publisher import publishMessage
...
def page_outputter(config: ConfigParser, bucket: Bucket, page: Page,
    ...
    # stats[bucket] += blob_count
    # try:
    #     pickled_object = pickle.dumps(page)
    #     publishMessage(pickled_object)
    #     LOG.info("%s page records written for bucket %s.", pickled_object)
    # except Exception:
